...
export const OS_TOOL_DEFINITIONS: OsToolDefinition[] = [
  ...
  },
  {
    ...
    shortSummary: 'Content depth, coverage, and usefulness lab.',
    detailedSummary:
      'Content Lab analyzes depth, coverage, and usefulness of content across key topics, personas, and funnel stages.',
    helpsAnswer:
      'Do we have enough of the right content to educate, nurture, and convert our best customers?',
    primaryOutputs: [
      'Content depth & coverage assessment',
      'Topic and funnel gaps',
  ...
  },
  {
    ...
    shortSummary: 'Demand gen channel & campaign effectiveness lab.',
    detailedSummary:
      'Demand Lab evaluates how well campaigns and channels are designed to create, capture, and convert demand across the funnel.',
    helpsAnswer:
      'Are our campaigns and channels designed to reliably generate qualified demand?',
    primaryOutputs: [
      'Channel mix assessment',
      'Campaign gaps & opportunities',
      'Prioritized demand gen experiments',
    ],
    influences: ['Strategy', 'Blueprint Focus', 'Work', 'Analytics'],
    status: 'comingSoon',
  },
