    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
        <Link
          ...
          className="flex flex-col items-center gap-2 p-4 rounded-xl bg-slate-900 border border-slate-800 hover:border-amber-500/50 hover:bg-amber-500/5 transition-colors group"
        >
        ...
        <Link
          ...
          className="flex flex-col items-center gap-2 p-4 rounded-xl bg-slate-900 border border-slate-800 hover:border-blue-500/50 hover:bg-blue-500/5 transition-colors group"
        >
        ...
        <Link
          ...
          className="flex flex-col items-center gap-2 p-4 rounded-xl bg-slate-900 border border-slate-800 hover:border-emerald-500/50 hover:bg-emerald-500/5 transition-colors group"
        >
        ...
        <Link
          ...
          className="flex flex-col items-center gap-2 p-4 rounded-xl bg-slate-900 border border-slate-800 hover:border-cyan-500/50 hover:bg-cyan-500/5 transition-colors group"
        >
