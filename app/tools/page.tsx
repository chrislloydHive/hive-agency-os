      ...
      <section className="mb-12">
        <header className="mb-4">
          ...
          <p className="mt-1 text-xs text-slate-500">
            Cross-company pattern analysis and emergent intelligence across your entire workspace.
          </p>
        </header>

        <Link
          href="/meta"
          className="group bg-gradient-to-br from-purple-900/30 to-slate-900/50 border border-purple-800/50 rounded-xl p-5 hover:border-purple-700 hover:from-purple-900/40 transition-all block"
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-slate-100 font-medium group-hover:text-purple-400 transition-colors">
                Meta Intelligence
              </h3>
              <p className="text-sm text-slate-500 mt-1">
                Discover patterns across all companies, detect global anomalies, compare vertical benchmarks, and surface emergent insights from your portfolio.
              </p>
