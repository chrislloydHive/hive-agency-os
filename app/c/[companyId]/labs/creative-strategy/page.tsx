// app/c/[companyId]/labs/creative-strategy/page.tsx
// Creative Strategy Lab V1 - Page

import { getCompanyById } from '@/lib/airtable/companies';
import { FEATURE_FLAGS } from '@/lib/config/featureFlags';
import { CreativeStrategyLabClient } from './CreativeStrategyLabClient';

type PageProps = {
  params: Promise<{ companyId: string }>;
};

export default async function CreativeStrategyLabPage({ params }: PageProps) {
